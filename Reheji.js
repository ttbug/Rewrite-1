...
;eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('2 N=w $O!=="x";2 P=w $Q!=="x";2 R={1h:"y://1i.1j.1k/1l/S",1m};1n T(a){1o U 1p((z,o)=>{7(N){$O.1q(a).V(z).W(o)}h 7(P){$Q.1r(a,(j,k,e)=>{7(j){o(j)}h{k.A=e;z(k)}})}h{B.C("不支持的代理工具");o("不支持的代理工具")}})}T(R).V(k=>{2 X=Y.1s(k.A);2 Z=X.S;1t f,p,g,c,e,D=E;q(2 8 F[10,1u]){q(2 i 1v 8){2 G=8===10?1w:1x;7(U 1y(`^${i}`,`i`).G(G)){7(8[i].H.11(\'1z\')){e={"l":"d-0-4:0:5","r":"s-0-4:0:5"}}h 7(8[i].H.11(\'1A\')){e={"l":"d-0-4:0:5"}}h 7(8[i].H.1B(\'1C\')!=-1){D=1D;f="3"}g=8[i].12;f=8[i].f||\'\';c=8[i].c;p=8[i].p;13}}7(f&&g)13}7(D){3.6.u=3.6.u||{};3.6.u=9.b(3.6.u||{},{[g]:[{"12":"1E","14":E,"l":"d-0-4:0:5","r":"s-0-4:0:5","15":"d-0-4:0:5","16":"17","18":"19"}]});3.6.I=3.6.I||{};3.6.I[g]={"l":"d-0-4:0:5","r":"s-0-4:0:5"}}q(2[1F,J]F 9.1G(Z)){2 1a=J.K;2 m=J.m;q(2 1b F m){2 1c=f||1b;2 L=g||1a;2 v=e||{"l":"d-0-4:0:5","r":"s-0-4:0:5"};9.b(3.6.m||{},{[1c]:9.b({},v,{K:L})});2 M=9.b({},v,{"1H":"3","1I":"y://t.1d/3","1J":"仅供学习，禁止转载或售卖","15":"d-0-4:0:5","14":E,"18":"19","16":"17","1K":"1L"});9.b(3.6.1e||{},{[L]:M});7(w c!==\'x\'&&c!==1M){9.b(3.6.m,{[p]:9.b({},v,{K:c})});9.b(3.6.1e,{[c]:M})}}}1f.A=Y.1N(3);B.C(\'已操作成功🎉🎉🎉\\n叮当猫の分享频道: y://t.1d/3\');$1g(1f)}).W(j=>{B.C("1O: "+j);$1g({})});',62,113,'09||const|chxm1023|09T09|09Z|subscriber|if|src|Object||assign|idb|2023|data|name|ids|else||error|response|purchase_date|entitlements||reject|nameb|for|expires_date|2099||non_subscriptions|finalData|typeof|undefined|https|resolve|body|console|log|anchor|false|of|test|cm|other_purchases|productInfo|product_identifier|finalIds|subdata|isQuanX|task|isOther|httpClient|options|product_entitlement_mapping|fetchRequest|new|then|catch|ent|JSON|productEntitlementMapping|listua|includes|id|break|is_sandbox|original_purchase_date|store|app_store|store_transaction_id|490001314520000|productIdentifier|entitlement|finalName|me|subscriptions|chxm1024|done|url|api|revenuecat|com|v1|headers|function|return|Promise|fetch|get|parse|let|bundle|in|ua|bundle_id|RegExp|sja|sjb|indexOf|sjc|true|888888888|entitlementId|entries|Author|Telegram|warning|ownership_type|PURCHASED|null|stringify|Error'.split('|'),0,{}));
